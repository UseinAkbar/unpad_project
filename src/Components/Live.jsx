...
const Live = () => {
  ...
  const currentURL = `https://www.youtube.com/live_chat?v=M8a632AOpJc&embed_domain=${window.location.hostname}`
  const option = {
              height: '460',
              width: '600',
              playerVars: {
    ...
    return (
        <section className='stream'>
          ...
          <div className={`stream__video ${isCollapse && 'streamCollapse'}`}>
            <Youtube className='yt' videoId='M8a632AOpJc' opts={option} />
          </div>
